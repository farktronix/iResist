...
set -o pipefail && xcodebuild clean build -sdk iphonesimulator -project iResist.xcodeproj -scheme iResist CODE_SIGNING_REQUIRED=NO | bundle exec xcpretty -f `xcpretty-travis-formatter`
